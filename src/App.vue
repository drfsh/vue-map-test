<template>
  <div id="app">
    ...
    @click="addMarker"
      :zoom="10"
      :center="[35.757552763570196,51.41000747680664]"
      style="height: 500px; width: 500px"
    >
      <l-tile-layer
        url="https://api.cedarmaps.com/v1/tiles/cedarmaps.streets/{z}/{x}/{y}.png?access_token=34052ca203989a39a2d0823ec968c10c8bf1f0fb"
        attribution="&copy; <a href='http://osm.org/copyrighte'>OpenStreetMap</a> contributors"
      />
      <v-marker-cluster>
        <l-marker
          :lat-lng="[35.757552763570196,51.41000747680664]"
          :icon="defaultIcon"
        />
      </v-marker-cluster>
    </l-map>
